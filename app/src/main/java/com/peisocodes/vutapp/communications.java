...
public class communications extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isNetworkAvailable(getApplicationContext())) {
            ...
            String url ="https://www.vut.ac.za/for-the-media/";
            WebView communicationsWebView = findViewById(R.id.communications_webView);
            communicationsWebView.setWebViewClient(new communications.MyWebViewClient());
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            view.loadUrl("https://www.vut.ac.za/for-the-media/");
            return true;
        }
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            progressDialog = new ProgressDialog(communications.this);
